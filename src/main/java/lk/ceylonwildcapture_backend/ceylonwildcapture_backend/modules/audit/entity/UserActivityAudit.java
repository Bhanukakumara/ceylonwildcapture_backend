...
/**
 * Entity representing a user activity audit record.
 * Tracks user profile changes, password resets, and other user-initiated actions.
 */
@Entity
@Table(name = "user_activity_audits", indexes = {
